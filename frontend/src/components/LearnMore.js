      ...
      <main className="purpose-content">
        <div className="purpose-header">
          ...
          <p className="purpose-text">
            GroupCart provides a seamless platform for coordinating payment and
            aquisition of shared goods between roomates, families, and
            organizations.
          </p>
          <p className="purpose-text">
            Easily keep track of orders and connect with others.
          </p>
          <p className="purpose-text">Interested? Join GroupCart today!</p>
          <div className="purpose-footer">
            <NavLink
              className="purpose-link hover-underline-animation"
            ...
            <p className="purpose-footer-text">🛒💸</p>
          </div>
        </div>
      </main>
    </div>
